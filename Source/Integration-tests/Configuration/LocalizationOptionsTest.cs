...
namespace RegionOrebroLan.Localization.IntegrationTests.Configuration
{
	[TestClass]
	public class LocalizationOptionsTest : SerializationTest
	{
		...
		public void JsonDeserialization_ShouldDeserializeCorrectly()
		{
			...
			var localizationOptions = JsonConvert.DeserializeObject<LocalizationOptions>("{\"EmbeddedResourceAssemblies\":[\"System.Private.CoreLib\",\"RegionOrebroLan.Localization.IntegrationTests\"],\"FileResourcesDirectoryPath\":\"Test\"}");
			...
			Assert.AreEqual("RegionOrebroLan.Localization.IntegrationTests", localizationOptions.EmbeddedResourceAssemblies.ElementAt(1));
			...
			localizationOptions = JsonConvert.DeserializeObject<LocalizationOptions>("{\"AlphabeticalSorting\":false,\"EmbeddedResourceAssemblies\":[\"System.Private.CoreLib\",\"RegionOrebroLan.Localization.IntegrationTests\"],\"FileResourcesDirectoryPath\":\"Test\",\"ThrowErrors\":true}");
		...
		public void JsonSerialization_IfTheLocalizationOptionsInstanceHavePropertiesSet_ShouldSerializeCorrectly()
		{
			...
			Assert.AreEqual("{\"AlphabeticalSorting\":true,\"EmbeddedResourceAssemblies\":[\"System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\",\"RegionOrebroLan.Localization.IntegrationTests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9aeba83ffb1feacc\"],\"FileResourcesDirectoryPath\":\"Test\",\"IncludeParentCultures\":false,\"ThrowErrors\":false}", this.JsonSerialize(localizationOptions));
		}
