...
namespace RegionOrebroLan.Localization.IntegrationTests.Prerequisites
{
	...
	public class ResourceManagerStringLocalizerFactoryPrerequisiteTest
	{
		...
		public void Create_ShouldCreateAStringLocalizerWithCorrectResourceBaseName()
		{
			...
			Assert.AreEqual("RegionOrebroLan.Localization.IntegrationTests.TestResources.ResxResources.Prerequisites.ResourceManagerStringLocalizerFactoryPrerequisiteTest", secondBaseName);
		}
