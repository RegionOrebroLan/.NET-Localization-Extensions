...
{
	public abstract class BasicCacheLocalizationProvider<TResourceProvider, TSettings> : ILocalizationProvider where TResourceProvider : IResourceProvider where TSettings : ILocalizationSettings
	{
		#region Constructors

		protected BasicCacheLocalizationProvider(ILocalizationPathResolver localizationPathResolver, ILocalizedStringFactory localizedStringFactory, ILoggerFactory loggerFactory, TResourceProvider resourceProvider, TSettings settings)
		{
		...
		protected internal virtual object LocalizationsLock { get; } = new();
		protected internal virtual ConcurrentDictionary<string, ILocalizedString> LocalizedStringCache { get; } = new(StringComparer.OrdinalIgnoreCase);
		protected internal virtual ILocalizedStringFactory LocalizedStringFactory { get; }
		protected internal virtual ConcurrentDictionary<string, IEnumerable<ILocalizedString>> LocalizedStringsWithoutParentCulturesIncludedCache { get; } = new(StringComparer.OrdinalIgnoreCase);
		protected internal virtual ConcurrentDictionary<string, IEnumerable<ILocalizedString>> LocalizedStringsWithParentCulturesIncludedCache { get; } = new(StringComparer.OrdinalIgnoreCase);
