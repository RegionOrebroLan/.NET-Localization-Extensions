...
namespace RegionOrebroLan.Localization.UnitTests.Prerequisites
{
	[TestClass]
	public class ResourceManagerStringLocalizerFactoryPrerequisiteTest
	{
		...
		public void GetResourcePrefix_WithTypeInfoParameter_Test()
		{
			...
			Assert.AreEqual("RegionOrebroLan.Localization.UnitTests.Resource_Path.Prerequisites.ResourceManagerStringLocalizerFactoryPrerequisiteTest", stringLocalizerFactory.GetProtectedResourcePrefix(this.GetType().GetTypeInfo()));
